...
<!-- JS begin some js files in bottom of file-->
      ...
      <div id="loader3" class="loader-cont">Please enable JS</div>
		...
		<div id="wrap" class="boxed ">
			<div class="grey-bg"> <!-- Grey BG  -->	
				...
				<!-- HEADER 1 NO-TRANSPARENT FONT BLACK -->
                ...
                <div class="logo-2">
                  <a href="index.html" class="clearfix">
                    <img src="images/icbtech.png" class="logo-img" alt="Logo">
                  </a>
                </div>
              </div>
						<!-- BUTTON --> 
                    ...
                    <nav class="collapse collapsing navbar-collapse right-1024">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="parent current">
                          ...
                          <li class="parent">
                            <a href="#" class="current open-sub">Page Titles</a>
                            <ul class="sub">
                              <li><a class="current" href="page-title-small-grey.html">Small Grey</a></li>
        ...
        <div class="page-title-cont page-title-small bg-gray">
          <div class="relative container align-left">
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="page-title">Used technologies</h1>
              </div>
	...
	<h4 class="mb-30">PHP</h4>
	<blockquote class="mb-50">
                <p>PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP 
...
<div id="blockquotes" class="bs-docs-section mb-100">
	<h4 class="mb-30">Laravel</h4>
	<blockquote class="mb-50">
                <p>LaravelLaravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel 
                	Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel 
                	Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel 
                	Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel 
                	Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel Laravel 
    			</p>
              </blockquote>
          </div>	

          <div id="blockquotes" class="bs-docs-section mb-100">
	<h4 class="mb-30">MySQL</h4>
	<blockquote class="mb-50">
                <p>MySQL MySQL MySQL MySQL MySQL MySQL MySQL MySQL MySQL MySQL MySQL MySQL 
          ...
          <div id="blockquotes" class="bs-docs-section mb-100">
	<h4 class="mb-30">HTML/CSS</h4>
	<blockquote class="mb-50">
                <p> HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS 
                	HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS 
                	HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS 
                	HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS HTML/CSS 
          ...
          <div id="blockquotes" class="bs-docs-section mb-100">
	<h4 class="mb-30">JS/jQuery</h4>
	<blockquote class="mb-50">
                <p>JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery 
                	JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery 
                	JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery 
                	JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery JS/jQuery 
